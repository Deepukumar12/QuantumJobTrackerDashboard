...
import { JobSimulator } from "@/lib/job-simulator.helper";
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    simulator.onStatusChange((jobId: string, status: any, error?: string | null) => {
      updateJobStatus.mutate(
        { id: jobId, status, error: error || undefined },
        {
          onSuccess: () => {
            ...
            toast({
              ...
              description: `${jobId}: ${(statusMessages as any)[status] || status}`,
